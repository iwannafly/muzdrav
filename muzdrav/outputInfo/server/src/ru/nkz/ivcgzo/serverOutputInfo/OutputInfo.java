...
/*	@SuppressWarnings("deprecation")
	...
	//Удалить
	@Override
	public void deleteVT(VrachTabel vt) throws KmiacServerException, TException {
	...
	//Добавить
	@Override
	public int addVT(VrachTabel vt) throws VTException, VTDuplException, KmiacServerException, TException {
		int id = vt.getId();
		try (SqlModifyExecutor sme = tse.startTransaction()) {
			...
			e.printStackTrace();
			throw new KmiacServerException("blabla");
		}
	}	
