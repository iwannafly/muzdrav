...
public class ReservedTalonTableCellRenderer extends JLabel implements TableCellRenderer {
    ...
    public final Component getTableCellRendererComponent(final JTable table, final Object value,
        ...
        setOpaque(true);
        int curVidp = ((ReservedTalonTableModel) table.getModel()).getReservedTalonList()
                .get(row).getVidp();
        switch (curVidp) {
            case 0:
