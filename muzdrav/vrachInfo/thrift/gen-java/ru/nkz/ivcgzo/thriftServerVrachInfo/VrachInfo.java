...
public class VrachInfo implements org.apache.thrift.TBase<VrachInfo, VrachInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField POL_FIELD_DESC = new org.apache.thrift.protocol.TField("pol", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  private static final org.apache.thrift.protocol.TField OBR_FIELD_DESC = new org.apache.thrift.protocol.TField("obr", org.apache.thrift.protocol.TType.STRING, (short)7);
  ...
  public VrachInfo setPol(int pol) {
    this.pol = pol;
    setPolIsSet(true);
    return this;
  }
  ...
  public VrachInfo setObr(String obr) {
    this.obr = obr;
    return this;
  }
  ...
  public boolean equals(VrachInfo that) {
    ...
    boolean this_present_obr = true && this.isSetObr();
    boolean that_present_obr = true && that.isSetObr();
    if (this_present_obr || that_present_obr) {
      if (!(this_present_obr && that_present_obr))
        return false;
      if (!this.obr.equals(that.obr))
        return false;
    }
