...
struct Priem{
	...
	19: string t_koj_pokr;
	20: string t_sliz;
	21: string t_podk_kl;
	22: string t_limf_uzl;
	23: string t_kost_mysh;
	24: string t_nervn_ps;
	25: optional string t_chss;
	26: optional string t_temp;
	27: string t_ad;
	28: string t_rost;
	29: string t_ves;
	30: string t_telo;
	...
	41: string t_pol_rta;
	42: string t_jivot;
	43: string t_palp_jivot;
	44: string t_jel_kish;
	45: string t_palp_jel;
	46: string t_palp_podjjel;
	47: string t_pechen;
	48: string t_jelch;
	49: string t_selez;
	50: string t_obl_zad;
	...
	55: string t_gr_jel;
	56: string t_matka;
	57: string t_nar_polov;
	58: string t_chitov;
	59: string t_st_localis;
	60: string t_ocenka;
	61: string t_jalob;
	62: string t_ist_zab;
	63: string t_status_praesense;
	64: string t_fiz_obsl;
}
...
service ThriftOsm extends kmiacServer.KmiacServer {
	...
	AnamZab getAnamZab(1: i32 obrId, 2: i32 npasp) throws (1: kmiacServer.KmiacServerException kse);
