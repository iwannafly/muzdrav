...
public class Vvod extends JFrame {
	...
	private ThriftIntegerClassifierCombobox<IntegerClassifier> CBTonus;
			...
			gl_PnlDiag.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_PnlDiag.createSequentialGroup()
					...
					.addGroup(gl_PnlDiag.createParallelGroup(Alignment.LEADING)
						.addComponent(label)
						.addComponent(spDiag, GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_PnlDiag.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(gl_PnlDiag.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_PnlDiag.createSequentialGroup()
							...
							.addGroup(gl_PnlDiag.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(spDiag, GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))))
					.addContainerGap())
		);
				...
				.addGroup(gl_pnlDiag.createSequentialGroup()
					...
					.addGroup(gl_pnlDiag.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_pnlDiag.createSequentialGroup()
							.addGroup(gl_pnlDiag.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnlDiag.createSequentialGroup()
									.addComponent(chbDiagInv, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(chbDiagBer, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE))
								.addGroup(gl_pnlDiag.createSequentialGroup()
						...
						.addGroup(gl_pnlDiag.createSequentialGroup()
							.addGroup(gl_pnlDiag.createParallelGroup(Alignment.TRAILING)
								.addComponent(PnlDiag, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 629, Short.MAX_VALUE)
								.addGroup(Alignment.LEADING, gl_pnlDiag.createSequentialGroup()
									.addComponent(lblDiagOpis, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(spDiagOpis, GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE))
								.addGroup(Alignment.LEADING, gl_pnlDiag.createSequentialGroup()
									.addComponent(pnlDiagStat, GroupLayout.PREFERRED_SIZE, 364, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(pnlDiagPredv, GroupLayout.DEFAULT_SIZE, 259, Short.MAX_VALUE))
								.addGroup(Alignment.LEADING, gl_pnlDiag.createSequentialGroup()
									.addGap(10)
								...
								.addGroup(Alignment.LEADING, gl_pnlDiag.createSequentialGroup()
									.addComponent(pnlDiagStadZab, GroupLayout.PREFERRED_SIZE, 313, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(pnlDiagHarZab, GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE))
								.addComponent(pnlDiagDisp, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
							.addGap(147))))
		);
		gl_pnlDiag.setVerticalGroup(
			gl_pnlDiag.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlDiag.createSequentialGroup()
					.addGap(1)
					.addComponent(PnlDiag, GroupLayout.PREFERRED_SIZE, 151, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_pnlDiag.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblDiagOpis)
						.addComponent(spDiagOpis, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_pnlDiag.createParallelGroup(Alignment.LEADING)
...
//		 		}
		...
		lblSrokBer.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblOkrJiv = new JLabel("Окружность живота");
		lblOkrJiv.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblVdm = new JLabel("ВДМ");
		lblVdm.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblTolPl = new JLabel("Толщина плаценты");
		lblTolPl.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		SSrok = new CustomTextField();
		SSrok.setFont(new Font("Tahoma", Font.BOLD, 12));
		SSrok.setColumns(10);
		
		 SOkrj = new CustomTextField();
		...
		SVdm.setColumns(10);
		 ...
		 STolP.setFont(new Font("Tahoma", Font.BOLD, 12));
		STolP.setColumns(10);
...
//не добавлен классификатор DB14!!!		
					...
					.addGroup(gl_pnlIzmer.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnlIzmer.createSequentialGroup()
							...
							.addGroup(gl_pnlIzmer.createParallelGroup(Alignment.LEADING, false)
								.addComponent(STolP, 0, 0, Short.MAX_VALUE)
								.addComponent(SVdm, 0, 0, Short.MAX_VALUE)
								.addComponent(SOkrj, 0, 0, Short.MAX_VALUE)
								.addComponent(SSrok, GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)))
						.addGroup(gl_pnlIzmer.createSequentialGroup()
							.addComponent(lblNewLabel)
							.addGap(28)
							.addComponent(CBTonus, 0, 121, Short.MAX_VALUE)))
					.addContainerGap())
		);
		gl_pnlIzmer.setVerticalGroup(
			gl_pnlIzmer.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlIzmer.createSequentialGroup()
					...
					.addGroup(gl_pnlIzmer.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel)
						.addComponent(CBTonus, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				rddin.setId_pos(tblPos.getSelectedItem().id);
...
//				rddin.setOteki(oslrod);
				...
				if (CBTonus.getSelectedPcod() != null)
					rddin.setTonus(CBTonus.getSelectedPcod());
...
//				}
		...
		gl_pnlDinBer.setVerticalGroup(
			gl_pnlDinBer.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlDinBer.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnlDinBer.createParallelGroup(Alignment.LEADING, false)
						.addComponent(pnlIzmer, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(pnlPlod, GroupLayout.PREFERRED_SIZE, 149, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_pnlDinBer.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_pnlDinBer.createSequentialGroup()
		...
		lblChssPlod.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblPolojPlod = new JLabel("Положение плода");
		lblPolojPlod.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblPredlejPlod = new JLabel("Предлежание плода");
		lblPredlejPlod.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		JLabel lblSerdcePlod = new JLabel("Сердцебиение плода");
		lblSerdcePlod.setFont(new Font("Tahoma", Font.PLAIN, 12));
		
		SChcc = new CustomTextField();
		...
		gl_pnlPlod.setHorizontalGroup(
			gl_pnlPlod.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlPlod.createSequentialGroup()
					...
					.addGap(13)
					.addGroup(gl_pnlPlod.createParallelGroup(Alignment.LEADING, false)
						.addComponent(SChcc, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(CBCerd, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(CBPredPl, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(CBPolPl, GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
						.addComponent(CBSerd1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		...
		gl_pnlPlod.setVerticalGroup(
			gl_pnlPlod.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlPlod.createSequentialGroup()
					...
					.addGroup(gl_pnlPlod.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblPolojPlod)
						.addComponent(CBPolPl, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_pnlPlod.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblPredlejPlod)
		...
		public void valueChanged(ListSelectionEvent arg0) {
			if (!arg0.getValueIsAdjusting() && (tblPos.getSelectedItem() != null)){
				...
				if (rddin.isSetTonus())
					CBTonus.setSelectedPcod(rddin.getTonus());
				else
