...
public class ServerLab extends Server implements Iface{
    ...
    @Override
    public List<PokazMet> getPokazMet(String cNnz1, int cotd)
    ...
    @Override
    public List<IntegerClassifier> getLabs(int clpu)
            throws KmiacServerException {
    ...
    @Override
    public List<StringClassifier> getOrgAndSys(int cotd)
