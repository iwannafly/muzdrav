	...
	//	frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
		...
		//		SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyy");
			...
			//		SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyyy");
			        ...
			        try {
						servPath = MainForm.tcl.getInvInfoPol(MainForm.authInfo.cpodr, SimpleDateFormat.getDateInstance().parse("01.01.2012").getTime(), SimpleDateFormat.getDateInstance().parse("31.12.2012").getTime());
					} catch (ParseException e3) {
						// TODO Auto-generated catch block
						e3.printStackTrace();
					}
