...
import ru.nkz.ivcgzo.clientHospital.views.ChildbirthPanel;

public class ChildbirthController implements IComponentController {
    private IHospitalModel model;
    private ChildbirthPanel view;

    public ChildbirthController(final IHospitalModel curModel) {
        this.model = curModel;
        this.view = new ChildbirthPanel(this, model);
