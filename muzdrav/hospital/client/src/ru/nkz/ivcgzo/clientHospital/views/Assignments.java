 ...
 */
public final class Assignments extends JPanel implements IPatientObserver {

	private static final long serialVersionUID = 3513837719265529747L;
    private static final String TOOLTIP_TEXT =
            "<html><b>Назначения</b> - позволяет лечащему врачу сохранять информацию "
            + "о назначенных пациенту медикаментах и процедурах</html>";
    private static final URL ICON = MainFrame.class.getResource(
            "/ru/nkz/ivcgzo/clientHospital/resources/medication.png");
    private static final String TITLE = "Назначения";
    ...
    public Assignments(final AssignmentsController inController,
        ...
        this.model = inModel;
        // регистрация слушателя модели. позволяет реагировать на смену пациента
        model.registerPatientObserver((IPatientObserver) this);

        setAssignmentsPanel(model.getPatient());
    }

	public void setAssignmentsPanel(final TPatient patientInfo) {
